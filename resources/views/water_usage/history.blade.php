...
@section('title', 'Household Usage History')
...
<div class="usage-history-container">
    <div class="page-header">
        <h1><i class="fas fa-history"></i> Household Usage History</h1>
        <p class="subtitle">Detailed water consumption patterns for all households</p>
    </div>
    ...
    <div class="filter-card">
        <form method="GET" action="{{ route('history') }}">
            <div class="filter-row">
                <div class="filter-group">
                    ...
                    <select name="month" id="month" class="form-select">
                        @foreach($months as $key => $month)
                            <option value="{{ $key }}" {{ $filters['month'] == $key ? 'selected' : '' }}>{{ $month }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="filter-group">
                    <label for="user_id"><i class="fas fa-user"></i> Household:</label>
